...
import { emailRegex, idRegex, nickNameRegex, passwordRegex } from '@Utils/regexes';

const Register = () => {
  const history = useHistory();

  const username = useInput('kozel');
  const email = useInput('kozel@naver.com');
  const name = useInput('kozel');
